...
public:
	...
	*/
	static void EncodeString( const TiXmlString& str, std::string* out );
...
public:
	...
	*/
	std::string ValueStr() { return value.ValueStr(); }
	#endif

	std::string ValueTStr() { return value.ValueStr(); }
...
protected:
	...
	TiXmlString		value; // contains nearly all data
